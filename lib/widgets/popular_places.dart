      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            const Text('popular places', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey)).tr(),
            const Spacer(),
            IconButton(icon: const Icon(Icons.arrow_forward),
              onPressed: () => nextScreen(context, const MorePlacesPage(title: 'popular', color: Colors.grey,)),
            )
          ],),
        ),
